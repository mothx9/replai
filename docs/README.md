...
| What proves capability admission and degradation? | [Terminal capability evidence](engineering/terminal-capabilities.md) |
| What proves blocking/session/reactor convergence? | [Embedding evidence](engineering/embedding.md) |
